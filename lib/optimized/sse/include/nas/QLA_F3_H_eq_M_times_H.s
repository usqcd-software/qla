;
; QLA_F3_H_eq_M_times_H( QLA_HalfFermion *cc, QLA_ColorMatrix *aa, QLA_HalfFermion *bb )
;

global QLA_F3_H_eq_M_times_H
QLA_F3_H_eq_M_times_H:
	push		ebp
	mov		ebp,esp
	push		eax
	push		ebx
	push		ecx
	mov		ecx,[ebp+8]			; su3_vector *cc[2]
	mov		eax,[ebp+12]			; su3_matrix *aa
	mov		ebx,[ebp+16]			; su3_vector *bb[2]
	...
	shufps		xmm6,xmm6,0x00
	shufps		xmm7,xmm7,0x00
	xorps		xmm0,[negate]			;				<_sse_sgn13>
	xorps		xmm1,[negate]			; 				<_sse_sgn13>
	xorps		xmm2,[negate]			;				<_sse_sgn13> 
	mulps		xmm6,xmm0
	mulps		xmm7,xmm1
	addps		xmm3,xmm6
	addps		xmm4,xmm7
