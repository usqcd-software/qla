;
; QLA_F3_V_meq_Ma_times_V( QLA_F3_ColorVector *aa, QLA_F3_ColorMatrix *bb, QLA_F3_ColorVector *cc )
; mult_adj_su3_mat_vec( su3_matrix *a, su3_vector *b, su3_vector *c)
;

global QLA_F3_V_meq_Ma_times_V
QLA_F3_V_meq_Ma_times_V:
	push	ebp
	mov	ebp,esp
	push	eax
	push	ebx
	...
	movups		xmm4,[eax]			; load result		<(aa)->c[0]>
	mulps		xmm5,xmm2
	addps		xmm3,xmm5			; a1i,a1r,a0i,a0r
        subps		xmm4,xmm3
	movups		[eax],xmm4			; store result		<(aa)->c[0]>
	...
	movlps		xmm4,[eax+16]			;			<(aa)->c[2]>
	addps		xmm6,xmm7
	subps		xmm4,xmm6
	movlps		[eax+16],xmm4			;			<(aa)->c[2]>
