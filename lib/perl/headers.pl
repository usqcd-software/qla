...
%carith2 = (
	    ...
	    'eqr*ca',  "QLA_c_eq_r_times_ca",    # c = a * conj(b) (a real)
	    'eqmr*ca', "QLA_c_eqm_r_times_ca",   # c = -(a * conj(b)) (a real)
	    'peqr*ca', "QLA_c_peq_r_times_ca",   # c += a * conj(b) (a real)
	    'meqr*ca', "QLA_c_meq_r_times_ca",   # c -= a * conj(b) (a real)
