...
unary(V,eq_eigenvalsH,M)
unary(M,eq_inverse,M)
unary(M,eq_sqrt,M)
unary(M,eq_sqrtPH,M)
unary(M,eq_invsqrt,M)
unary(M,eq_invsqrtPH,M)
unary(M,eq_exp,M)
unary(M,eq_expA,M)
unary(M,eq_expTA,M)
unary(M,eq_log,M)
...
void do_mrc(FILE *fp) {
alleqops(`alltensors3(`binaryconst',',`_r_times,R)')
alleqops(`binaryconst(M,',`_r_times,R,M,a)')
alleqops(`binaryconst(P,',`_r_times,R,P,a)')
alleqops(`alltensors3(`binaryconst',',`_c_times,C)')
alleqops(`binaryconst(M,',`_c_times,C,M,a)')
alleqops(`binaryconst(P,',`_c_times,C,P,a)')
alleqops(`alltensors2(`unarytimesi',',`_i)')
}
...
alleqops(`binary(M,',`,R,times,Ma,sR1,sM2)')
alleqops(`binary(P,',`,R,times,Pa,sR1,sP2)')
...
alleqops(`binary(M,',`,C,times,Ma,sC1,sM2)')
alleqops(`binary(P,',`,C,times,Pa,sC1,sP2)')

alleqops(`binary(V,',`,Ca,times,V,sC1,sV2)')
alleqops(`binary(H,',`,Ca,times,H,sC1,sH2)')
alleqops(`binary(D,',`,Ca,times,D,sC1,sD2)')
alleqops(`binary(M,',`,Ca,times,M,sC1,sM2)')
alleqops(`binary(P,',`,Ca,times,P,sC1,sP2)')
alleqops(`binary(M,',`,Ca,times,Ma,sC1,sM2)')
alleqops(`binary(P,',`,Ca,times,Pa,sC1,sP2)')
...
alleqops(`binary(C,',`,Pa,dot,P,sP1,sP2)')
alleqops(`binary(C,',`,P,dot,Pa,sP1,sP2)')
alleqops(`binary(C,',`,Ma,dot,M,sM1,sM2)')
alleqops(`binary(C,',`,M,dot,Ma,sM1,sM2)')
